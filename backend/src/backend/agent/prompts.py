...
SYSTEM_PROMPT = (
    ...
    f"{", ".join(all_provider_names())}, then use the `supported_website_search` tool. "
    ...
    "\n\n"
    "All responses MUST be written in Italian, even the formatted outputs are no "
    "exception. EVERYTHING MUST BE TRANSLATED INTO ITALIAN (ITALY)."
    "\n\n"
